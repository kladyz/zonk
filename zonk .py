...
# and https://github.com/gitnready/gwc19-game/blob/master/python/randStart.py
...
player = pygame.image.load('../img/kiss.jpg').convert()
playerCoord = [0,0]
icon0 = pygame.image.load('../img/helmet.jpg').convert() 
icon1 = pygame.image.load('../img/leo.jpg').convert()
icon2 = pygame.image.load('../img/girl2.jpg').convert()
icon3 = pygame.image.load('../img/percy.jpg').convert()
